    ...
    <div class="grid grid-cols-7 gap-2 text-xs sm:min-w-[75rem] max-w-[100rem]">
        ...
        @foreach ($weather as $w)
            @php
                ...
                $lightness = $c?->commit_count ? 100 * $c->commit_count : 0;
                $darkness = 700 - $lightness;
            @endphp

            <div class="flex flex-col items-center bg-gray-{{ $darkness }} text-gray-{{ $lightness < 300 ? '50' : '900' }} border-2 border-gray-900 rounded p-2 gap-2 rounded-xl font-semibold">
